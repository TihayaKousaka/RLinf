...
def main(cfg) -> None:
    # HF_LEROBOT_HOME must be a filesystem root, not the Hydra ListConfig of
    # datasets. Respect an existing env var and otherwise infer the common
    # parent directory from the first dataset path.
