...
from rlinf.models.embodiment.openpi.policies import rlt_maniskill_policy


@dataclasses.dataclass(frozen=True)
class LeRobotRLTManiSkillDataConfig(DataConfigFactory):
    """DataConfig for the RLT ManiSkill LeRobot schema."""
    ...
    def create(
        ...
        data_transforms = _transforms.Group(
            inputs=[
                rlt_maniskill_policy.RLTManiSkillInputs(
                    model_type=model_config.model_type,
                    default_prompt=self.default_prompt,
                )
            ],
            outputs=[rlt_maniskill_policy.RLTManiSkillOutputs()],
        )
