...
## What's NEW!
- [2026/06] 🔥 RLinf adds a dedicated ManiSkill joint-control RLT tutorial covering data collection, Stage1 RL token training, and Stage2 online TD3. Doc: [ManiSkill Joint-Control RLT](https://rlinf.readthedocs.io/en/latest/rst_source/examples/embodied/maniskill_rlt_joint.html).
